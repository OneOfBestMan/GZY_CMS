	...
	styleUI : {
		jQueryUI : {
			...
			base : {
                ...
                icon_first: "ui-icon ace-icon fa fa-angle-double-left bigger-140",
                icon_prev: "ui-icon ace-icon fa fa-angle-left bigger-140",
                icon_next: "ui-icon ace-icon fa fa-angle-right bigger-140",
                icon_end: "ui-icon ace-icon fa fa-angle-double-right bigger-140",
